---
name: API Sync Operations Guide
overview: Guia operativa completa de todos los botones de sync, que hace cada uno, cuantos requests consume, y en que orden usarlos.
todos: []
isProject: false
---
...
### Escenario 4: Tu situacion real ahora

Polla 13 de Marzo (Aqueduct, 6 carreras en el evento, 8 totales del hipodromo). Las carreras ya corrieron ayer.
